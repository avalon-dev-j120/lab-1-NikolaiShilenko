...
public class Task4 implements Task {
	...
	public void run() {
		 ...
		 *
		 * 1. С использованием отладчика проверьте, что сравнение объектов класса Person
		 * выполняется некорректно.
		 *
		 * 2. Переопределите в классе Person методы equals и hashCode.
		 *
		 * 3. С использованием отладчика проверьте что сравнение объектов типа Person
